...
# --- THEME DESIGN SYSTEM (Sakura Blossom Rose (Light)) ---
BG = '#FFF5F5'
SURFACE = '#FFFFFF'
TEXT = '#7A1C1C'
MUTED = '#B85C5C'
...
def main(page: ft.Page):
    page.title = "Kavakuru Metarere - SiteSpy Portfolio"
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Text("Kavakuru Metarere", size=34, weight=ft.FontWeight.W_900, color=TEXT),
                    ft.Row([
                        ...
                        ft.Text("kavakurum@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/Kavakuru-Metarere7", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['src/screens/ForgotPasswordScreen.js', 'src/screens/LoginScreen.js', 'src/screens/RegisterScreen.js', 'src/services/authService.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Authentication screens and auth service integration.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Kavakuru Metarere"\ngit config user.email "kavakurum@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Kavakuru Metarere | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
